---
title: '消息队列选型'
date: 2022-03-15 19:56:34
tags: [MQ]
published: true
hideInList: false
feature: /post-images/DyzAzkEVU.png
isTop: false
---
### 消息队列
常用的消息队列主要这 4 种，分别为 Kafka、RabbitMQ、RocketMQ 和 ActiveMQ，主要介绍前三，不BB，上思维导图！

![](https://tianxiawuhao.github.io/post-images/1657627504417.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627512680.png)

#### 消息队列模式

- 点对点模式：多个生产者可以向同一个消息队列发送消息，一个具体的消息只能由一个消费者消费。

![](https://tianxiawuhao.github.io/post-images/1657627520099.png)

- 发布/订阅模式：单个消息可以被多个订阅者并发的获取和处理。

![](https://tianxiawuhao.github.io/post-images/1657627527080.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627597961.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627604741.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627611867.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627618721.png)

**如果消费者增加，会触发 Rebalance，也就是分区和消费者需要重新配对**。

**不同的消费群组互不干涉**，比如下图的 2 个消费群组，可以分别消费这 4 个分区的消息，互不影响。

![](https://tianxiawuhao.github.io/post-images/1657627625216.png)

> 更多知识，详见[Kafka 架构深入](https://tinaxiawuhao.github.io/post/KM-0yw6ab/)
...
![](https://tianxiawuhao.github.io/post-images/1657627636503.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627647064.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627658105.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627665439.png)

![](https://tianxiawuhao.github.io/post-images/1657627671336.png)
...
![](https://tianxiawuhao.github.io/post-images/1657627677983.png)
